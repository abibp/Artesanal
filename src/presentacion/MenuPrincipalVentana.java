...
public class MenuPrincipalVentana extends javax.swing.JFrame {
    ...
    private enum Paneles {
        ...
        RegistroProducto("presentacion.productos.RegistroProductoFormularioPanel"),
        EliminacionProducto("presentacion.productos.EliminacionProductoFormularioPanel"),
        ModificacionProducto("presentacion.productos.ModificacionProductoFormularioPanel"),
        ...
        RegistroInsumo("presentacion.insumos.RegistroInsumoFormularioPanel"),
        EliminacionInsumo("presentacion.insumos.EliminacionInsumoFormularioPanel"),
        ModificacionInsumo("presentacion.insumos.ModificacionInsumoFormularioPanel"),
        InventarioInsumos("presentacion.insumos.InventarioInsumosPanel"),
        RegistroProveedor("presentacion.proveedores.RegistroProveedorFormularioPanel"),
        EliminacionProveedor("presentacion.proveedores.EliminacionProveedorFormularioPanel"),
        ModificacionProveedor("presentacion.proveedores.ModificacionProveedorFormularioPanel"),
