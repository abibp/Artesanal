 ...
 * @author PIX
 */
public class AutocompletadoCodigoProveedorDialogo extends javax.swing.JDialog {

    private JTextField campoPorLlenar_;
    private ModeloPersonalizadoTabla proveedoresTablaModelo_;
    
    public AutocompletadoCodigoProveedorDialogo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tituloPanel.setText("Proveedores Disponibles");
        tituloPanel.setFont(new java.awt.Font("Dialog", 1, 36)); // NOI18N

        insumosUsadosEtiqueta.setText("Da doble click sobre un proveedor para seleccionarlo");
        ...
        barraDesplazamientoTabla.setViewportView(proveedoresTabla);
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(fondoPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 584, Short.MAX_VALUE)
        );
    ...
    private void configurarComponentes() {
        ...
        String[] cabeceraTabla = {"ID proveedor", "Nombre", "Telefono"};
        proveedoresTablaModelo_ = new ModeloPersonalizadoTabla(cabeceraTabla);
        proveedoresTabla.setModel(proveedoresTablaModelo_);
        llenarTabla();
        agregarEventoTabla();
    }
        ...
        MouseAdapter manejadorAccionesClick = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent eventoClick) {
                if (eventoClick.getClickCount() == DOBLE_CLICK) {
                    autocompletarCodigoProveedor();
                }
            }
        };
        
        this.proveedoresTabla.addMouseListener(manejadorAccionesClick);
    }
    ...
    private void autocompletarCodigoProveedor() {
        ...
        if (esFilaValida()) {
            ...
            int indiceFila = proveedoresTabla.getSelectedRow();

            String valorID = proveedoresTablaModelo_.
